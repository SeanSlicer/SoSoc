...
export default function NavSidebar({ user: initialUser }: { user: NavUser }) {
  ...
  return (
    <>
      ...
      <nav
        className="fixed bottom-0 left-0 right-0 z-50 flex md:hidden items-center justify-around border-t border-neutral-200 bg-white/95 backdrop-blur-sm px-2 pt-2"
      ...
      >
        ...
        <button
          onClick={() => void handleSignOut()}
          aria-label="Sign out"
          className="relative flex items-center justify-center rounded-xl p-3 text-neutral-500 hover:text-red-600 transition-colors"
        >
