...
export default function SearchPage() {
  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-6">
      <div className="sticky top-0 bg-white/90 backdrop-blur-sm pb-4 z-10">
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-xl border border-neutral-200 bg-neutral-50 py-2.5 pl-9 pr-4 text-sm focus:border-indigo-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/20 transition-colors"
          />
        </div>
      </div>
          ...
          {results.map((user) => (
            <li key={user.id}>
              <Link
                ...
                className="flex items-center gap-3 py-3 hover:bg-neutral-50 rounded-xl px-2 transition-colors"
              >
