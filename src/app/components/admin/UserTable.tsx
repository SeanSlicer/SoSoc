        ...
        <tbody className="divide-y divide-neutral-100">
          {users.map((user) => (
            <tr key={user.id} className="hover:bg-neutral-50 transition-colors">
              ...
              <td className="px-4 py-3 text-right text-neutral-600">{user._count.posts}</td>
              <td className="px-4 py-3 text-right text-neutral-600">{user._count.followers}</td>
              ...
              <td className="px-4 py-3 text-right">
                <button
                  ...
                  className="rounded-lg border border-neutral-200 px-3 py-1.5 text-xs font-medium text-neutral-600 hover:border-indigo-300 hover:bg-indigo-50 hover:text-indigo-700 disabled:opacity-50 transition-colors"
                >
